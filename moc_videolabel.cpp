...
#include "../../computer-vision/BullsEYE/videolabel.h"
...
void VideoLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        VideoLabel *_t = static_cast<VideoLabel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (VideoLabel::*)(QPoint );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoLabel::moved)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject VideoLabel::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_VideoLabel.data,
      qt_meta_data_VideoLabel,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void VideoLabel::moved(QPoint _t1)
{
